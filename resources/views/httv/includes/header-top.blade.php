<div class="header-top section d-none d-sm-block">
        <div class="container">
            <div class="row">
                ...
                <div class="header-top-links col-md-9 col-6">
                    ...
                    <ul class="header-links">
                        <li class="disabled block d-none d-md-block"><a href="#"><i class="fa fa-clock-o"></i>{{ \Carbon\Carbon::now()->toDayDateTimeString() }}</a></li>
