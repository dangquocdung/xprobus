		...
		<div class="row">
				<div class="col-sm-12">
					<ul class="logo-group">
						...
						<li class="partner-logo border-b">
							<img src="/xpro/assets/images/client-logo/2.png" alt="">
						</li>
						<li class="partner-logo border-b">
							<img src="/xpro/assets/images/client-logo/3.png" alt="">
						</li>
						<li class="partner-logo border-b">
							<img src="/xpro/assets/images/client-logo/4.png" alt="">
						</li>
						<li class="partner-logo border-b">
							<img src="/xpro/assets/images/client-logo/5.png" alt="">
						</li>
					</ul>
				</div>
			</div>
