                            ...
                            <div class="input-group input-group-sm">
                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            {!! Form::text('title_vi',$EditedMenu->title_vi, array('placeholder' => trans('backLang.menuTitle').strip_tags(trans('backLang.arabicBox')),'class' => 'form-control','id'=>'title_vi','required'=>'')) !!}
                                        </div>
                                    </div>
                                @endif
                        ...
                        @else
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            {!! Form::text('title_vi','', array('placeholder' => trans('backLang.menuTitle').strip_tags(trans('backLang.arabicBox')),'class' => 'form-control','id'=>'title_vi','required'=>'')) !!}
                                        </div>
                                    </div>
                                @endif
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
