                    ...
                    <div class="box-body">
                        ...
                        @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('title_vi',$Sections->title_vi, array('placeholder' => '','class' => 'form-control','id'=>'title_vi','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                                </div>
                            </div>
                        @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_title_vi',$Sections->seo_title_vi, array('class' => 'form-control','id'=>'seo_title_vi','maxlength'=>'65', 'dir'=>trans('backLang.rtl'))) !!}
                                            </div>
                                        </div>
                                    @endif
