                ...
                <div class="tab-content pos-rlt">
                        ...
                        <div class="p-a-md col-md-12">
                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('site_title_vi',$Setting->site_title_vi, array('placeholder' => trans('backLang.websiteTitle'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'))) !!}
                                </div>
                            @endif
                    ...
                    <div class="tab-pane {{ ( Session::has('socialTab') ? 'active' : '') }}" id="tab-3">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-youtube-play"></i> &nbsp; {!!  trans('backLang.ytlist') !!}
                                </label>
                                {!! Form::text('social_link5',$Setting->social_link11, array('placeholder' => trans('backLang.ytlist'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'))) !!}
                            </div>
                    ...
                    <div class="tab-pane {{ ( Session::has('styleTab') ? 'active' : '') }}" id="tab-5">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group row">
                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                    <div class="col-sm-6">
                                        <label for="style_logo_vi">{!!  trans('backLang.siteLogo') !!} @if(Helper::GeneralWebmasterSettings("vi_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.arabicBox') !!}@endif</label>
                                        ...
                                        @endif
                                        {!! Form::file('style_logo_vi', array('class' => 'form-control','id'=>'style_logo_vi','accept'=>'image/*')) !!}
                                        <small>
                                ...
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                    <div class="col-sm-6">
                                        <label for="style_logo_en">{!!  trans('backLang.siteLogo') !!} @if(Helper::GeneralWebmasterSettings("vi_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.englishBox') !!}@endif</label>
