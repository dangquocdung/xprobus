                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <label for="longtext_status1"
                                   class="col-sm-2 form-control-label">{!!  trans('backLang.sapoField') !!}</label>
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('sapo_status','1',($WebmasterSections->sapo_status==1) ? true : false, array('id' => 'sapo_status1','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ trans('backLang.yes') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('sapo_status','0',($WebmasterSections->sapo_status==0) ? true : false, array('id' => 'sapo_status2','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ trans('backLang.no') }}
                                    </label>
                                </div>
                                ...
                                <div>
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('title_vi','', array('placeholder' => '','class' => 'form-control','id'=>'file_title_vi','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div id="options" style="display: none">
                                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                <div class="col-sm-3 col-xs-5">
                                                    ...
                                                    {!! Form::textarea('details_vi','', array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'12','style'=>'white-space: nowrap;')) !!}
                                                    <small>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="lang_code" id="lang_code" class="form-control c-select">
                                                ...
                                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                    <option value="vi">العربية</option>
                                                @endif
                                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                ...
                                <div>
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('title_vi',Session::get('WebmasterSectionField')->title_vi, array('placeholder' => '','class' => 'form-control','id'=>'file_title_vi','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                        ...
                                        <div id="options"
                                            ...
                                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                <div class="col-sm-3 col-xs-5">
                                                    ...
                                                    {!! Form::textarea('details_vi',Session::get('WebmasterSectionField')->details_vi, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'12','style'=>'white-space: nowrap;')) !!}
                                                    <small>
                                                        <i class="material-icons">&#xe8fd;</i> {!!  trans('backLang.customFieldsOptionsHelp') !!}
                                                    </small>
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="lang_code" id="lang_code" class="form-control c-select">
                                                ...
                                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                    <option value="vi" {{ (Session::get('WebmasterSectionField')->lang_code=="vi")?"selected='selected'":"" }}>
                                                        العربية
                                                    </option>
                                                @endif
                                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                            ...
                            <div class="row">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_title_vi',$WebmasterSections->seo_title_vi, array('class' => 'form-control','id'=>'seo_title_vi','maxlength'=>'65', 'dir'=>trans('backLang.rtl'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_url_slug_vi',$WebmasterSections->seo_url_slug_vi, array('class' => 'form-control','id'=>'seo_url_slug_vi', 'dir'=>trans('backLang.rtl'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_description_vi',$WebmasterSections->seo_description_ar, array('class' => 'form-control','id'=>'seo_description_vi','maxlength'=>'165', 'dir'=>trans('backLang.rtl'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_keywords_vi',$WebmasterSections->seo_keywords_ar, array('class' => 'form-control','id'=>'seo_keywords_vi', 'dir'=>trans('backLang.rtl'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        ...
                                        if ($WebmasterSections->seo_title_vi != "") {
                                            $seo_example_title = $WebmasterSections->seo_title_vi;
                                        }
                                        if ($WebmasterSections->seo_description_vi != "") {
                                            $seo_example_desc = $WebmasterSections->seo_description_vi;
                                        }
                                        if ($WebmasterSections->seo_url_slug_vi != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                            $seo_example_url = url($WebmasterSections->seo_url_slug_vi);
                                        } else {
    ...
    <script type="text/javascript">
        ...
        $("#seo_title_vi").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_vi").text("<?php echo str_replace("backLang.", "", trans('backLang.' . $WebmasterSections->name)); ?>");
            }
        });
        ...
        $("#seo_url_slug_vi").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#url_in_engines_vi").text("<?php echo url($WebmasterSections->name); ?>");
            }
        });
        @endif
        @if(Helper::GeneralWebmasterSettings("en_box_status"))
