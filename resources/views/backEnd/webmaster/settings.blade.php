            ...
            <div class="form-group">
                ...
                <div class="radio">
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('vi_box_status','1',$WebmasterSetting->vi_box_status ? true : false , array('id' => 'vi_box_status1','class'=>'has-value')) !!}
                        <i class="dark-white"></i>
                        {{ trans('backLang.active') }}
                    </label>
                    &nbsp; &nbsp;
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('vi_box_status','0',$WebmasterSetting->vi_box_status ? false : true , array('id' => 'vi_box_status2','class'=>'has-value')) !!}
                        <i class="dark-white"></i>
