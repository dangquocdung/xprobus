            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title_vi',$Banners->title_vi, array('placeholder' => '','class' => 'form-control','id'=>'title_vi','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                        </div>
                    </div>
                @endif
                ...
                @if($WebmasterBanner->desc_status)
                    ...
                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('details_vi',$Banners->details_vi, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'3')) !!}
                            </div>
                        </div>
