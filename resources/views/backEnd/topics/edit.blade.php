            ...
            <div class="tab-content clear b-t">
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                  ...
                  <span class="fa fa-calendar"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="section_id[]" id="section_id" class="form-control select2-multiple"
                                        ...
                                        ?>
                                        @foreach ($fatherSections->where('status','1') as $fatherSection)
                                            <?php
                        ...
                        @if($WebmasterSection->sapo_status)

                            <div class="form-group row">
                                <label for="sapo"
                                    class="col-sm-2 form-control-label">Sapo
                                </label>
                                <div class="col-sm-10">
                                    <div class="box p-a-xs" style="margin-bottom:0">
                                        {!! Form::textarea('sapo',$Topics->sapo, array('placeholder' => 'Sapo','class' => 'form-control','rows' => '3')) !!}
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="box p-a-xs">
                                                {!! Form::textarea('details_vi',$Topics->details_vi, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote', 'dir'=>trans('backLang.rtl'),'ui-options'=>'{height: 300}')) !!}
                                            </div>
                                        </div>
                                    </div>
                                @endif
                            ...
                            @else
                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea('details_vi',$Topics->details_vi, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'5')) !!}
                                        </div>
                                    </div>
                                @endif
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group row">
                                            <label for="files_file"
                                                   class="col-sm-2 form-control-label">{!!  trans('backLang.topicAttach') !!}</label>
                                            <div class="col-sm-10">
                                                {!! Form::file('file', array('class' => 'form-control','id'=>'attach_file','required'=>'','accept'=>'.pdf,.docx,.xlsx')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row m-t-md" style="margin-top: 0 !important;">
                                            <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <div>
                                        ...
                                        @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    {!! Form::text('title_vi',Session::get('AttachFile')->title_vi, array('placeholder' => '','class' => 'form-control','id'=>'file_title_vi','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                                                </div>
                                            </div>
                                        @endif
                                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                        ...
                                        <div class="col-sm-offset-2 col-sm-8">
                                            ...
                                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        {!! Form::text('title_vi',Session::get('Map')->title_vi, array('placeholder' => '','class' => 'form-control','id'=>'title_vi', 'dir'=>trans('backLang.rtl'))) !!}
                                                    </div>
                                                </div>
                                            @endif
                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                            ...
                                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        {!! Form::textarea('details_vi',Session::get('Map')->details_vi, array('placeholder' => '','class' => 'form-control','id'=>'details_vi','rows'=>'3', 'dir'=>trans('backLang.rtl'))) !!}
                                                    </div>
                                                </div>
                                            @endif
                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                                        ...
                                                        <div>
                                                            ...
                                                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::text('title_vi','', array('placeholder' => '','class' => 'form-control','id'=>'title_vi', 'dir'=>trans('backLang.rtl'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                                            ...
                                                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::textarea('details_vi','', array('placeholder' => '','class' => 'form-control','id'=>'details_vi','rows'=>'3', 'dir'=>trans('backLang.rtl'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                ...
                google.maps.event.addListener(map, 'click', function (e) {
                    ...
                    geocoder.geocode({
                        ...
                        if (status == google.maps.GeocoderStatus.OK) {
                            if (results[0]) {
                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                $("#details_vi").val(results[0].formatted_address);
                                @endif
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
