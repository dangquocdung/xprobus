            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title_vi','', array('placeholder' => '','class' => 'form-control','id'=>'title_vi','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="box p-a-xs" style="margin-bottom:0">
                            {!! Form::textarea('sapo','', array('placeholder' => 'Sapo','class' => 'form-control','rows' => '3')) !!}
                        </div>
                    </div>
                </div>
                    ...
                    @else
                        @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('details_vi','', array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'5')) !!}
                                </div>
                            </div>
                        @endif
                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
