            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title_vi',$Menus->title_vi, array('placeholder' => '','class' => 'form-control','id'=>'title_vi','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                        </div>
                    </div>
                @endif
                ...
                <div id="link_div" class="form-group row" style="{{ ($Menus->type ==1)? "":"display: none" }}">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('link',$Menus->link, array('placeholder' => '','class' => 'form-control','id'=>'title_vi', 'dir'=>trans('backLang.ltr'))) !!}
                    </div>
                </div>
