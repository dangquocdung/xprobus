...
Route::Group(['prefix' => env('BACKEND_PATH', 'admin')], function () {
    ...
    Route::middleware(['checklevel','managerlevel'])->group(function () {
        ...
        // lich phat song
        Route::get('/lich-phat-song', 'LpsController@index')->name('lich-phat-song');
        Route::get('/lich-phat-song/create/{sectionId}', 'LpsController@create')->name('LpsCreate');
        Route::post('/lich-phat-song/store', 'LpsController@store')->name('LpsStore');
        Route::get('/lich-phat-song/{id}/edit', 'LpsController@edit')->name('LpsEdit');
        Route::post('/lich-phat-song/{id}/update', 'LpsController@update')->name('LpsUpdate');
        Route::get('/lich-phat-song/destroy/{id}', 'LpsController@destroy')->name('LpsDestroy');
        Route::post('/lich-phat-song/updateAll', 'LpsController@updateAll')->name('LpsUpdateAll');
...
// ../site map
Route::get('/lps', 'FrontendHomeController@lps')->name('lps');
...
// ..Calendar
Route::get('/lich-cong-tac-iframe', 'FrontendHomeController@LichCongTacPage')->name('lichcongtacPage');

// ..Calendar
Route::get('/lich-cong-tac', 'FrontendHomeController@LichCongTac')->name('lichcongtac');

//Phat thanh online
Route::get('/phat-thanh', 'FrontendHomeController@getPhatThanh')->name('phat-thanh');

Route::get('/truyen-hinh', 'FrontendHomeController@getTruyenHinh')->name('truyen-hinh');

Route::get('/truyen-hinh-2', 'FrontendHomeController@getTruyenHinh2')->name('truyen-hinh-2');

//Lich truyen hinh
Route::Group(['prefix' => '/ajax'], function () {
    Route::post('/lich-truyen-hinh', 'AjaxController@LichTruyenHinh');
    Route::post('/lich-phat-thanh', 'AjaxController@LichPhatThanh');
});
