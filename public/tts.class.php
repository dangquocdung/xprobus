...
DEFINE('APIKEY','jLVpKCJFPQ798Ha2iqYA4lDs1brzWg'); //enter your api key here. Acquire your key by visiting http://portalas.org/scripts/tts/register/
DEFINE('AUDIO_DIR','audio/'); // default: audio/ where url is domain.com/audio/
