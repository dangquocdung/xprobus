...
class SectionsController extends Controller
{
    ...
    public function store(Request $request, $webmasterId)
    {
        ...
        $Section->title_vi = $request->title_vi;
        ...
        // Meta title
        $Section->seo_title_vi = $request->title_vi;
        $Section->seo_title_en = $request->title_en;

        //URL Slugs
        $slugs = Helper::URLSlug($request->title_vi, $request->title_en, "category", 0);
        $Section->seo_url_slug_vi = $slugs['slug_vi'].'-'.rand(1111,9999);
        $Section->seo_url_slug_en = $slugs['slug_en'].'-'.rand(1111,9999);
