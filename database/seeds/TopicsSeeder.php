...
class TopicsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Topic->title_vi = "من نحن";
        $Topic->title_en = "About Us";
        $Topic->details_vi = "هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن التركيز على الشكل الخارجي للنص.";
        ...
        $Topic->row_no = 4;
        $Topic->webmaster_id = 1;
        $Topic->title_vi = "الشروط والأحكام";
