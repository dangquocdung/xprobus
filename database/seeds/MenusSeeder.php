...
class MenusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Menu1->row_no = 1;
        $Menu1->father_id = 0;
        $Menu1->title_vi = "القائمة الرئيسية";
