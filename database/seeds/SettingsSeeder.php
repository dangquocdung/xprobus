...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $settings->site_title_vi = "اسم الموقع";
        $settings->site_title_en = "Site Title";
        $settings->site_desc_vi = "وصف الموقع الإلكتروني ونبذة قصيره عنه";
        $settings->site_desc_en = "Website description and some little information about it";
        $settings->site_keywords_vi = "كلمات، دلالية، موقع، موقع إلكتروني";
        ...
        $settings->contact_t1_vi = "المبني - اسم الشارع - المدينة - الدولة";
        ...
        $settings->contact_t7_vi = "من الأحد إلى الخميس 08:00 ص - 05:00 م";
