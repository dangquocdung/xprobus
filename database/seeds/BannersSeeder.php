...
class BannersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Banner->row_no = 1;
        $Banner->section_id = 1;
        $Banner->title_vi = "بنر رقم ١";
        $Banner->title_en = "Banner #1";
        $Banner->details_vi = "هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن التركيز على الشكل الخارجي للنص.";
        ...
        $Banner->row_no = 1;
        $Banner->section_id = 2;
        $Banner->title_vi = "تصميم ريسبونسف";
        ...
        $Banner->row_no = 3;
        $Banner->section_id = 2;
        $Banner->title_vi = "باستخدام بوتستراب";
